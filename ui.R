...
################################
      tabItem(
        ...
        fluidRow(
          ...
          box(
            title = "Format de passation",
            width = 4,

            selectInput(
              "select_passation_format",
              label = h3("Présentation"),
              choices = c(),
              selected = NULL,
              multiple = TRUE
            ),
          ...
          box(
            title = "Type  de passation",
            width = 4,

            selectInput(
              "select_passation_type",
              label = h3("Type de Passation"),
              choices = c(),
              selected = NULL,
              multiple = TRUE
            ),
        ...
        fluidRow(
          fluidRow(
            column(11, DT::dataTableOutput("mytable"))
          )
        )
      ),
        ...
        box(
          ...
          fluidRow(
            column(
              4,
              h4("Abreviation : "),
              textOutput("scale_abrev"),
              h4("Publication : "),
              textOutput("scale_publication"),
              h4("Lien : "),
              htmlOutput("scale_pub_url")
            ),
            column(
              4,
              h4("Population : "),
              textOutput("scale_pop"),
              h4("Type de passation : "),
              textOutput("scale_pass_type"),
              h4("Format de passation : "),
              textOutput("scale_pass_format")
            ),
            column(4, h4("Langue : "), textOutput("scale_language"), ),
          ),
        ),
